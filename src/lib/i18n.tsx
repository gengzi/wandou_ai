...
const messages = {
  'zh-CN': {
    ...
    'login.loading': '登录中...',
    'login.failed': '登录失败',
    'login.kicker': '企业级创作工作台',
    'login.heroTitle': '从故事到可交付资产，同一条智能体生产线',
    'login.heroDesc': '登录后继续编排剧本、角色、分镜、视频任务和素材归档。',
    'login.secureBadge': 'Sa-Token 会话保护',
    'login.pipelineTitle': '今日工作流',
    'login.node.script': '剧本',
    'login.node.character': '角色',
    'login.node.storyboard': '分镜',
    'login.node.video': '视频',
    'login.node.assets': '资产',
    'login.panelKicker': '安全访问',
    'login.panelTitle': '欢迎回来',
    'login.panelDesc': '使用企业账号进入你的创作工作台。',
    'login.emailPlaceholder': '输入邮箱',
    'login.passwordPlaceholder': '输入密码',
    'login.footer': '登录后将恢复最近项目、模型配置和积分状态。',
    'badge.pro': '专业版',
    'badge.free': '免费',
    ...
    'home.highlights': '亮点',
    'home.close': '关闭',
    'home.attachmentNotice': '附件会上传到对象存储并进入项目素材库，后续 Agent 流程会读取项目参考图作为上下文。',
    'home.referenceNotice': '参考图已支持上传到对象存储，并会随项目上下文进入后续角色、分镜和视频生成流程。',
  ...
  'en-US': {
    ...
    'login.kicker': 'Enterprise Creative Workspace',
    'login.heroTitle': 'One agent production line from story to deliverable assets',
    'login.heroDesc': 'Continue scripts, characters, storyboards, video tasks, and asset archiving after login.',
    'login.secureBadge': 'Sa-Token session guard',
    'login.pipelineTitle': 'Today workflow',
    'login.node.script': 'Script',
    'login.node.character': 'Character',
    'login.node.storyboard': 'Storyboard',
    'login.node.video': 'Video',
    'login.node.assets': 'Assets',
    'login.panelKicker': 'Secure access',
    'login.panelTitle': 'Welcome back',
    'login.panelDesc': 'Use your enterprise account to enter the creative workspace.',
    'login.emailPlaceholder': 'Enter email',
    'login.passwordPlaceholder': 'Enter password',
    'login.footer': 'Recent projects, model settings, and credits are restored after login.',
    'badge.pro': 'PRO',
    'badge.free': 'Free',
    ...
    'home.close': 'Close',
    'home.attachmentNotice': 'Attachments are uploaded to object storage and saved into the project asset library for later Agent context.',
    'home.referenceNotice': 'Reference images can now be uploaded to object storage and used by the project generation flow.',
